  ...
  return(
    <form className={styles.searchForm}>
      <div>
        ...
        <input className={classNames(styles.searchForm_input, styles.navigation_firstFontStyle)} type='text' id="productName" {...productNameField} placeholder='Поиск по сайту'/>
      </div>
      <button className={classNames(styles.searchForm_button, {[styles.show]: productNameField.value, [styles.hide]: !productNameField.value})} onClick={processSubmit}>Найти</button>
    </form>
  )
}
